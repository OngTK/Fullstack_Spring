...
<body>
    ...
    <div>연락처<input type="text" id = "phone" disabled></div>
    <div>인원수<input type="number" id = "count" disabled></div>
    <div>등록 일시<input type="text" id = "wdate" disabled></div>

    <button onclick = "gotoWaitingUpdate()">수정하기</button>
    <button onclick = "waitingDelete()">삭제하기</button>
